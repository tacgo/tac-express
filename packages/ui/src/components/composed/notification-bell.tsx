                  ...
                  >
                    {n.link ? (
                      <Link
                        ...
                        className="flex flex-1 min-w-0 items-start gap-3 focus:outline-none focus-visible:tac-focus-premium"
                      >
                        {mainBody}
                      </Link>
                    ) : (
                      <Button
                        ...
                        className="flex flex-1 h-auto min-w-0 items-start gap-3 px-0 py-0 text-left font-normal hover:bg-transparent focus-visible:tac-focus-premium"
                      >
                        {mainBody}
                      </Button>
                    )}
