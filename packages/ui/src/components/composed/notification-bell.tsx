    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        <button
          data-slot="notifications-trigger"
          type="button"
          className="relative flex h-8 w-8 items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors rounded-[var(--radius-control)] focus-visible:outline-none focus-visible:tac-focus-premium"
                  ...
                  >
                    {n.link ? (
                      <Link
                        ...
                        className="flex flex-1 min-w-0 items-start gap-3 focus-visible:outline-none focus-visible:tac-focus-premium"
                      >
                        {mainBody}
                      </Link>
                    ) : (
                      <Button
                        ...
                        className="flex flex-1 h-auto min-w-0 items-start gap-3 px-0 py-0 text-left font-normal hover:bg-transparent"
                      >
                        {mainBody}
                      </Button>
                    )}
