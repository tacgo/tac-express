  ...
  return (
    <li className="grid gap-2 px-4 py-3">
      ...
      <div
        ...
        // 🛡️ Sentinel: Defensive sanitization to prevent XSS.
        // Even if the rich-text editor and backend produce sanitized HTML,
        // we must not blindly trust input at the rendering boundary.
