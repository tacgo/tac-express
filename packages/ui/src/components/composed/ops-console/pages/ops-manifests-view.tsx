                  ...
                  <OpsTableCell className="text-right">
                    {m.detailHref ? (
                      ...
                      <Link
                        ...
                        className="font-paper-mono text-[length:var(--text-ui-11)] tracking-badge uppercase text-paper-violet hover:underline underline-offset-4"
                      >
                        View →
                      </Link>
                    ) : (
                      <span
                        aria-hidden
                        className="font-paper-mono text-[length:var(--text-ui-11)] tracking-badge uppercase text-paper-fg-4"
                      >
                        —
                      </span>
                    )}
