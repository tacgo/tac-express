...
function OpsScanningView() {
  ...
  return (
    <OpsFrame>
      ...
      <div className="flex items-center justify-between mb-3.5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="font-paper-display font-bold text-[length:var(--text-ui-18)] mt-0.5">
              {current.id}{" "}
              <span className="font-paper-mono font-normal text-paper-fg-3 text-[length:var(--text-ui-12)] ml-1.5">
                · {current.sub}
              </span>
            </div>
          </div>
        ...
        <OpsCard ticks className="min-h-[length:var(--spacing-chart-lg)] flex flex-col">
          ...
          <div className="flex-1 grid place-items-center text-center text-paper-fg-3">
            <div>
              ...
              <div className="font-paper-display text-[length:var(--text-ui-13)]">
      ...
      <div className="flex items-center justify-between mt-3.5 font-paper-mono text-paper-fg-3 text-[length:var(--text-ui-11)] tracking-[length:var(--tracking-badge)]">
