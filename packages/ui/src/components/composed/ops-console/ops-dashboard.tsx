  ...
  return (
    <OpsFrame>
      ...
      >
        ...
        <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-paper-card border border-paper-line px-2.5 py-1.5 font-paper-mono font-medium text-paper-10 tracking-badge text-paper-fg-1">
          <span
            aria-hidden
