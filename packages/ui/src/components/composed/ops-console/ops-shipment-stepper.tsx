  ...
  if (isTerminal) {
    return (
      ...
      >
        ...
        <span className="font-paper-mono text-paper-err uppercase tracking-[length:var(--tracking-paper-10)] text-[length:var(--text-paper-12)]">
        ...
        return (
          <div key={status} className="flex items-center flex-shrink-0">
            <div className="flex flex-col items-center gap-1.5">
              ...
              <span
                className={cn(
                  "font-paper-mono uppercase tracking-[length:var(--tracking-paper-10)] whitespace-nowrap max-w-14 text-center leading-tight",
