    ...
    >
      <div className="flex items-center gap-3">
        <button
          ...
          className="focus-visible:outline-none focus-visible:tac-focus-premium inline-flex size-7 items-center justify-center border border-border tac-fui-hover"
        >
