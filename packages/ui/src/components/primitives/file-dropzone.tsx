          ...
          {value.map((f) => (
            ...
            >
              ...
              <button
                type="button"
                onClick={() => remove(f.id)}
                className="focus-visible:outline-none focus-visible:tac-focus-premium absolute right-1 top-1 flex size-6 items-center justify-center border border-border bg-background opacity-0 transition-opacity group-hover/dropzone-file:opacity-100 focus-visible:opacity-100"
