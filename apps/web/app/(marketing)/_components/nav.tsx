...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="focus-visible:outline-none focus-visible:tac-focus-premium flex size-9 items-center justify-center border border-border bg-background text-muted-foreground transition-colors hover:text-foreground"
    >
      {resolvedTheme === "dark" ? (
    ...
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      >
        ...
        <button
          ...
          aria-expanded={open}
          onClick={() => setOpen((o) => !o)}
          className="focus-visible:outline-none focus-visible:tac-focus-premium flex size-9 items-center justify-center border border-border bg-background text-foreground lg:hidden"
        >
          {open ? (
