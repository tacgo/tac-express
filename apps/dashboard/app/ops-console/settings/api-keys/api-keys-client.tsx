    ...
    <PageShell width="wide">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <label className="space-y-1">
            ...
            <select
              ...
              className="h-9 w-full border border-border bg-card px-2 font-mono text-sm tracking-wider uppercase"
            >
              {SCOPES.map((s) => (
      ...
      {revealed && (
        <div className="tac-fui-panel border-l-4 border-l-accent-warning bg-card p-4">
          <p className="font-mono text-xs tracking-wider text-accent-warning uppercase">
            Save this key now
          </p>
          <p className="mt-1 text-sm text-foreground">
            <strong>{revealed.name}</strong> — this token will not be shown
            again.
          </p>
      ...
      <div className="space-y-2">
        ...
        {(list.data ?? []).map((k) => (
          <div
            key={k.id}
            className="tac-fui-panel flex items-center justify-between gap-3 p-4"
          >
            ...
            {k.isActive && (
              ...
              >
                <RiCloseCircleLine className="mr-1 size-4" aria-hidden="true" />{" "}
                Revoke
              </Button>
            )}
          </div>
