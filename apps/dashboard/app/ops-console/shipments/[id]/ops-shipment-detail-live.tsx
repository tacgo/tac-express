        ...
        <OpsPanelTabsContent value="overview">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <OpsCard ticks>
              ...
              <div className="font-paper-display font-semibold text-[length:var(--text-ui-14)]">
                {shipment.sender?.name}
              </div>
              <div className="font-paper-mono text-[length:var(--text-ui-12)] text-paper-fg-3 mt-1">
                {shipment.sender?.phone}
              </div>
              {shipment.sender?.email && (
                <div className="font-paper-mono text-[length:var(--text-ui-12)] text-paper-fg-3">
                  {shipment.sender.email}
                </div>
              )}
              {shipment.sender?.address && (
                <div className="font-paper-display text-[length:var(--text-ui-13)] text-paper-fg-2 mt-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
            <OpsCard>
              ...
              <div className="font-paper-display font-bold text-[length:var(--text-ui-18)] mt-1 tabular-nums">
          ...
          {shipment.description && (
            <OpsCard ticks className="mt-4">
              ...
              <p className="font-paper-display text-[length:var(--text-ui-13)]">
                {shipment.description}
              </p>
            </OpsCard>
          )}
