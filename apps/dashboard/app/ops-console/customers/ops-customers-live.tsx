...
export function OpsCustomersLive() {
  ...
  // ⚡ Bolt: Memoize mapped data and avoid destructuring default arrays
  // This preserves referential equality for the TanStack table in V7OpsCustomers,
  // preventing expensive re-renders and state resets on every render pass.
