...
export function CustomerDetailClient({
    ...
    <div className="space-y-4">
      {editing ? (
        <div className="space-y-3 border border-border bg-card p-4">
          <p className="border-b border-border pb-2 font-mono text-ui-10 tracking-widest text-muted-foreground uppercase">
            Edit Customer
          </p>
          <CustomerForm
            defaultValues={{
  ...
  const shipmentsTab = (
    <div className="space-y-2">
      <h2 className="font-mono text-ui-10 tracking-widest text-muted-foreground uppercase">
        Customer shipments
      </h2>
    ...
    <div className="mx-auto max-w-5xl space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="h-8 border border-border px-3 font-mono text-xs tracking-wider text-muted-foreground uppercase hover:border-foreground hover:bg-transparent hover:text-foreground"
        >
