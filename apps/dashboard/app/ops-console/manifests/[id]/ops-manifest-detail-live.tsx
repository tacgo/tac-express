    ...
    >
        ...
        <OpsCard ticks>
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-paper-mono text-[length:var(--text-ui-12)] text-paper-fg-1">
                → {nextAction.label}
              </span>
            </div>
            <OpsButton
          ...
          <ul className="divide-y divide-paper-line">
            {shipments.map((s) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 font-paper-mono text-[length:var(--text-ui-12)] text-paper-fg-3 tabular-nums">
      ...
      {m.notes && (
        <OpsCard ticks>
          ...
          <p className="font-paper-mono text-[length:var(--text-ui-12)] text-paper-fg-1 whitespace-pre-line">
            {m.notes}
          </p>
        </OpsCard>
      )}
