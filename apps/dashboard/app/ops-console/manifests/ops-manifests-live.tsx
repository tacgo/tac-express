...
export function OpsManifestsLive() {
  ...
  // perf: memoize the items array so the V7OpsManifests table has a stable reference
  // Expected impact: Eliminates redundant re-renders of the table during hook loading states
