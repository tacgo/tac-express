...
/**
 * V8 invoice workflow — content only. The shared shell (sidebar + topbar),
 * `.dashboard-v8` scope, and fonts come from the segment layout (layout.tsx +
 * v8-chrome.tsx), so this multi-step invoice flow renders inside the same
 * navigable v8 dashboard as the overview. Editorial v8 language: centered form,
 * rounded-28 surface cards, semantic field widths, pill stepper, soft shadows.
  ...
  [
    {
      ...
      fields: [
        ...
        { label: "Booking Date", span: 6, w: "sm", type: "date" },
        {
          ...
          w: "md",
          type: "select",
          opts: ["To Pay", "Paid", "To be billed"],
        },
        { label: "Declared Value", span: 6, w: "sm", num: true, ph: "₹ 0" },
        {
          label: "Nature of Quantity",
          span: 12,
          w: "lg",
          ph: "Electronics, documents…",
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          w: "md",
          type: "select",
          opts: ["General", "Fragile", "Perishable", "Hazardous"],
        },
        {
          label: "Rate Type",
          span: 6,
      ...
      fields: [
        {
          ...
          span: 12,
          type: "textarea",
          ph: "Visible to ops only…",
        },
        {
          label: "Invoice Remarks",
          span: 12,
          type: "textarea",
          ph: "Printed on the invoice…",
        },
      ],
    },
  ]
    ...
    <div className="v8-page">
      ...
      <div className="py-6">
        ...
        <p className="v8-caption mt-2" style={{ maxWidth: 560 }}>
          Build an invoice step by step — booking basics, parties, cargo,
          charges, then review.
        </p>
      </div>
        ...
        <section className="v8-card">
          ...
          <div className="v8-fieldgrid">
            {active.fields.map((f) => (
              <div
                key={f.label}
                className="v8-field"
                style={{ gridColumn: `span ${f.span ?? 6}` }}
              >
          ...
          {active.id === "charges" && (
            <div className="v8-total mt-7">
              ...
              <span className="v8-metric" style={{ fontSize: "1.5rem" }}>
                ₹48,320
              </span>
            </div>
          )}
